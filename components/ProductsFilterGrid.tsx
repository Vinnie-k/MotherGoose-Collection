...
// Receives the already-fetched product list as a prop from the Server
// Component page (app/products/page.tsx) — no client-side fetch, no
// loading flash on first paint. All filtering/sorting stays client-side
// here since it needs to be instant as the user drags/clicks controls.
export default function ProductsFilterGrid({ allProducts }: { allProducts: Product[] }) {
